...
public interface PaymentsClient {
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "api/v1/payments/{paymentId}/status")
    void updateStatus(@PathVariable("paymentId") long paymentId, PaymentStatusUpdateRequest status);
}
